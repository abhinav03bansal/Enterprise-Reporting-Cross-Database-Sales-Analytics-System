...
Connects to PostgreSQL and bulk inserts customer, product, and sales data
"""
...
def create_connection(host='localhost', database='analytics_db', user='postgres', password='password', port='5432'):
    ...
    try:
        ...
        logging.info(f"Connected to PostgreSQL database: {database}")
        return connection
    except Error as e:
